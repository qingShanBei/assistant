 ...
 ;!function(win){
    ...
    Layui.prototype.use = function(apps, callback, exports){
      ...
      if(!config.modules[item]){
        ...
        if(dir.indexOf('/layui-v2.5.5')==-1){
          
            dir=sessionStorage.getItem('PsnMgrLgAssistantAddr')+'PsnMgr/LgAssistant/assets/layui-v2.5.5/layui/';
        }
    ...
    Layui.prototype.link = function(href, fn, cssname){
      ...
      ,timeout = 0;
     if(href.indexOf(sessionStorage.getItem('PsnMgrLgAssistantAddr'))==-1){ 
        href=sessionStorage.getItem('PsnMgrLgAssistantAddr')+'PsnMgr/LgAssistant/assets/layui-v2.5.5/layui/css/modules/laydate/default/laydate.css?v=5.0.9';
    }
      link.rel = 'stylesheet';
