...
function AgassitantCallbackFunction(result) {
    ...
    var isAddEvent =false; //是否已经开启页面间关联
        ...
        $.ajax({
            ...
            success: function (data, status) {
                ...
                if (StatusCode = 200) {
                    ...
                    sysIPArr[sysid] = sysid;
                    assistantBigSuccessFn('数据调用失败');
                    if (sysid == 400) {
                        $('.infoCenter-empty').show();
                        $('.infoCenter-empty-text').text('通知');
                    }
                }
    ...
    $('#Assistant_infoCenter').append($(
        '<b></b><i></i>'));
    $('body').append($('<div class="lgAssistant-infoCenter-main"><div class="assistant-box"><div class="assistant-popup"><div class="popup-main"><div class="assistant-small-success"><span><i></i><b class="assistant-small-text">操作成功！</b></span></div><div class="assistant-tips"><span><i></i><b class="assistant-tips-text">未找到相关联系人！</b></span></div><div class="assistant-big-success"><span><i></i><b class="assistant-big-text">操作成功!</b></span></div><div class="assistant-remind"><span><i class="assistant-remind-close"></i><p><i></i><span class="assistant-remind-text">操作询操作询问操作询问问</span></p><span class="assistant-remind-true">确定删除</span><span class="assistant-remind-false">再想想</span></span></div><div class="assistant-outline"><span><p><i></i><span class="assistant-outline-text">您已经掉线，请重新登录！</span></p><span class="assistant-outline-true">重新登录</span></span></div><div class="popup-main-nav popup-main1"><div class="infoCenter-title"><p>消息中心</p></div><ul><li class="info-active" name="1"><p class="info-active">待办事项<i></i></p></li><li name="2"><p>通知<i></i></p></li><li name="4"><p>系统消息<i></i></p></li><li name="5"><p>新闻资讯<i></i></p></li></ul><div class="infoCenter-setting"><i></i><span>设置</span></div><div class="infoCenter-empty"><i></i><p>暂时还没有<span class="infoCenter-empty-text">待办事项</span>哦~</p></div><div class="lgAssistant-clear"></div><div class="setting-popup"><div></div><div><div class="setting-close"><i></i><span>设置</span><i class="lgAssistant-close"></i></div><ul><li class="setting-active" name="setting-option1"><p class="setting-active">系统消息接收设置</p></li></ul><div class="lgAssistant-clear"></div><div></div><div class="setting-option setting-option1"></div><div class="setting-option setting-option2"></div><div class="setting-option setting-option3"></div></div><div></div></div><div class="infoCenter-option todo"><span class="todo-type-span" data-name="0"> 全部内容(共<strong>0</strong>项)<b></b><p></p><ul class="todo-type-ul"></ul></span><span> 期限 </span><div class="infoCenter-option-box todo-box"></div></div><div class="infoCenter-option message"><span> 标题(有<strong>0</strong>个未读通知)</span><span> 发布时间 </span><span> 发布人 </span><div class="infoCenter-option-box message-box"></div></div><div class="infoCenter-option chat"><span> 共有<strong>0</strong>条新消息</span><div class="infoCenter-option-box chat-box"><div class="chat-clear"><span><b></b>清除交流信息</span></div></div></div><div class="infoCenter-option notice"><span> 消息内容(有<strong>0</strong>条新消息)</span><span> 来源 </span><span> 时间 </span><div class="infoCenter-option-box notice-box"><div class="notice-clear"><span><b></b>清空系统信息</span></div></div></div><div class="infoCenter-option news"> <div class="news-type lgAssistant-clear"><span class="news-type-span">类别:</span> <ul class="news-type-ul "></ul>  </div><div class="news-box"></div></div></div><div class="assistant-popup-loading"><div class="frame_point_loading_container"><div class="point_container"><span class="point1 point"></span><span class="point2 point"></span><span class="point3 point"></span><span class="point4 point"></span></div></div></div></div></div></div></div>'));
    var infoID = document.getElementById('Assistant_infoCenter');
    // console.log(getElementPageLeft(infoID));
    // console.log(getElementPageTop(infoID));
    // $('#Assistant_infoCenter').attr('title', '');
    // var infoCenterBoxRight = -122 - $('#Assistant_infoCenter').css('width').slice(0, -2) / 3 + 'px';
    $('.assistant-box').css('width', 0);
    $('.assistant-box').css('height', 0);
    $('.lgAssistant-infoCenter-main').css('left', getElementPageLeft(infoID) + 'px');
    $('.lgAssistant-infoCenter-main').css('top', getElementPageTop(infoID) + 'px');
    ...
    $(window).resize(function () { //当浏览器大小变化时
        $('.lgAssistant-infoCenter-main').css('left', getElementPageLeft(infoID) * 1 + $('#Assistant_infoCenter').css('width').slice(0, -2) / 2 - 722 + 'px');
        $('.lgAssistant-infoCenter-main').css('top', getElementPageTop(infoID) * 1 + $('#Assistant_infoCenter').css('height').slice(0, -2) * 1 + 28 + 'px');
    });
    ...
    $('#Assistant_infoCenter').click(function () {
        ...
        if ($('.lgAssistant-infoCenter-main').css('opacity') == '0') {
            ...
            $('.lgAssistant-infoCenter-main').show();
            $('.lgAssistant-infoCenter-main').css('left', getElementPageLeft(infoID) * 1 + $('#Assistant_infoCenter').css('width').slice(0, -2) / 2 - 722 + 'px');
            $('.lgAssistant-infoCenter-main').css('top', getElementPageTop(infoID) * 1 + $('#Assistant_infoCenter').css('height').slice(0, -2) * 1 + 28 + 'px');
        ...
        if ($('.Assistant_infoCenter_popup') && $('.Assistant_infoCenter_popup').length == 0) {
            ...
            $('.Assistant_infoCenter_popup').off().click(function () {
                ...
                setTimeout(function () {
                    $('.lgAssistant-infoCenter-main').hide();
                }, 300);
                ...
                $('.todo-div').off().click(function () {
                    ...
                    if ($this.attr('data-PCLinkType') == 1) {
                        ...
                        if (!sysIPArr[$this.attr('data-SysID')]) {
                            getSysWeb($this.attr('data-SysID'),
                                function (data) {
                                    ...
                                    if (!isAddEvent) {
                                        ...
                                        addEvent(window, 'message', function (e) {
                                            try {
                                                if (e.data == 3 && infoCenterOption == 1) {
                                                    todoFn(0);
                                                } else if (e.data == 2 && infoCenterOption == 2) {
                                                    messageFn(0, '1');
                                                } else if (e.data == 3 && infoCenterOption == 4) {
                                                    noticeFn(0);
                                                    ajaxN('PsnMgr/InfoCentre/GetNewRemindCount', 'get', {}, function (data) {
                                                        if (data.Data.NoticeCount == 0) {
                                                            $('.popup-main1 ul li').eq(1).children().children().attr('class', '');
    ...
    function messageFn(page, state) {
        if (!messageURL && messageURL == 400) {
            getSysIP('400', function (data) {
                messageURL = data;
                if (messageURL != 400) {
                    messageFn(page, state);
                }
            });
                                ...
                                getSysWeb($this.attr('data-SysID'),
                                    function (data) {
                                        ...
                                        if ($this.attr('data-SysID') == 400) {
                                            url = url + '&lg_tk=' + sessionStorage.getItem('PsnMgrToken');
                                            if (!isAddEvent) {
                                                isAddEvent = true;
                                                addEvent(window, 'message', function (e) {
                                                    try {
